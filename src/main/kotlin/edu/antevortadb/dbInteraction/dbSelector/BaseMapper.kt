 ...
 * ResultSet but is used as a return type from buildMappers to avoid switching over the class type which is
 * become tedious to update as more DB types are added to the project
 */
