...
/**
 * This class implements the JSON specific code for parsing and pushing the data into a newly
 * created DB
 */
abstract class JsonPusher: DataPusher {
    ...
    // Custom setter for jsonStrings so that numObjects also gets set when setting jsonStrings
    // outside of c'tor
    set(value){
        field = value
    ...
    // Base DataPusher will handle the path to the DB, the names for the table columns, and the
    // table name
    ...
    override fun run(){
        ...
        // This is implemented by a derived class, specific to the data being read and data being
        // written to the DB
